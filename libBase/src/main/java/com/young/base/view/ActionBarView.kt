...
import com.young.base.config.BaseConfig
import com.young.module.libbase.R
import com.young.module.libbase.databinding.LayoutActionBarBinding
...
class ActionBarView : RelativeLayout {
     ...
     * 设置左边的图标及宽高距离左边的距离
     */
    fun setBarLeftIcons(icon: Int, l: Int = 0, w: Int = 0, h: Int = 0): ActionBarView {
        if (icon != View.NO_ID) {
