...
import com.young.network.errorhandler.ExceptionHandle;
import com.young.network.errorhandler.HttpErrorHandler;
import com.young.network.interceptor.RequestInterceptor;
import com.young.network.interceptor.ResponseInterceptor;
...
public class NetWorkApi {
    ...
    private static OkHttpClient getOkHttpClient() {
        ...
        if (okHttpClient == null) {
            ...
            //添加请求拦截器，如果接口有请求头的话，可以放在这个拦截养里面
